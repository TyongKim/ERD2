...
#%% Generate 
# This code randomly generates 10 bridges for each span
p3_value = []
for ii in range(10):
...
np.save('./generated_MDOF_systems/3_span_ver3.npy',p3_value)
np.save('./generated_MDOF_systems/4_span_ver3.npy',p4_value)
np.save('./generated_MDOF_systems/5_span_ver3.npy',p5_value)
np.save('./generated_MDOF_systems/6_span_ver3.npy',p6_value)
