...
for ii in range(3): # Number of ground motions
    ...
    for jj in range(2): # for each structure
        ...
        # SDOF analysis
        results_displ, results_accel = MDOF_3span_analysis(tmp_value2, tmp1_1, tmp1_2, tmp2)        
...
for ii in range(3): # ground motions
    ...
    for jj in range(2): # for each structure
        ...
        # SDOF analysis
        results_displ, results_accel = MDOF_4span_analysis(tmp_value2, tmp1_1, tmp1_2, tmp2)        
...
for ii in range(3): # ground motions
    ...
    for jj in range(2): # for each structure
        ...
        # SDOF analysis
        results_displ, results_accel = MDOF_5span_analysis(tmp_value2, tmp1_1, tmp1_2, tmp2)        
...
for ii in range(3): # ground motions
    ...
    for jj in range(2): # for each structure
        ...
        # SDOF analysis
        results_displ, results_accel = MDOF_6span_analysis(tmp_value2, tmp1_1, tmp1_2, tmp2)        
