...
3. Code_train_DNN.py: This script 
4. ERD_net_displ.h5: Trained deep neural network (DNN) model, termed ERD-net, using 'Code_train_DNN.py'. The results of the above reference is obatined using this DNN model.
